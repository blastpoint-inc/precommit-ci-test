...
[![CI](https://github.com/blastpoint-inc/precommit-ci-test/actions/workflows/ci.yml/badge.svg)](https://github.com/blastpoint-inc/precommit-ci-test/actions/workflows/ci.yml)
[![Release](https://github.com/blastpoint-inc/precommit-ci-test/actions/workflows/release.yml/badge.svg)](https://github.com/blastpoint-inc/precommit-ci-test/actions/workflows/release.yml)
[![DevContainer](https://github.com/blastpoint-inc/precommit-ci-test/actions/workflows/devcontainer.yml/badge.svg)](https://github.com/blastpoint-inc/precommit-ci-test/actions/workflows/devcontainer.yml)
[![CommitLint](https://github.com/blastpoint-inc/precommit-ci-test/actions/workflows/commitlint.yml/badge.svg)](https://github.com/blastpoint-inc/precommit-ci-test/actions/workflows/commitlint.yml)
[![Coverage](https://img.shields.io/endpoint?url=https://blastpoint-inc.github.io/precommit-ci-test/_static/badges/coverage.json)](https://blastpoint-inc.github.io/precommit-ci-test/reports/coverage)
[![PyPI](https://img.shields.io/pypi/v/precommit-ci-test)](https://pypi.org/project/precommit-ci-test/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/precommit-ci-test)](https://pypi.org/project/precommit-ci-test/)
[![GitHub](https://img.shields.io/github/license/blastpoint-inc/precommit-ci-test)](https://github.com/blastpoint-inc/precommit-ci-test/blob/main/LICENSE)
...
[![Open in Dev Containers](https://img.shields.io/static/v1?label=Dev%20Containers&message=Open&color=blue&logo=visualstudiocode)](https://vscode.dev/redirect?url=vscode://ms-vscode-remote.remote-containers/cloneInVolume?url=https://github.com/blastpoint-inc/precommit-ci-test)

> [!WARNING]
> _Precommit CI Test_ is in the **Alpha** phase.
> Frequent changes and instability should be anticipated.
> Any feedback, comments, suggestions and contributions are welcome!

[![Precommit CI Test](https://blastpoint-inc.github.io/precommit-ci-test/_static/images/logo.svg)](https://github.com/blastpoint-inc/precommit-ci-test)
...
MIT License, for more details, see the [LICENSE](https://github.com/blastpoint-inc/precommit-ci-test/blob/main/LICENSE) file.
